...
| CLI 디스패처 | `HgCliAction` 기반 옵션 파싱/디스패치 | 미커밋 |

### 미커밋 변경 (작업 트리)

- `hgfloater.c`: CLI 디스패처 추가 (+140줄)
- `TODO.md`: 2026-05-24 로그 및 CLI 디스패처 완료 반영

> 아직 `git commit`이 필요한 상태임.

---

## Next Actions

1. **미커밋 변경 커밋**: CLI 디스패처 작업 커밋 먼저 처리
2. **5. 전역 리소스 수명 주기**:
   - 공통 폰트/브러시/툴팁 소유권 정리
