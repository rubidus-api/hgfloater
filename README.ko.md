...
**v0.12.0** — 빌드 2026-08-13 19:45 KST
...
- **태스크박스는 자체 배경이 없습니다.** 아이콘 사이로 바탕화면이 그대로 비치고, 아이콘과
  그 라벨, 그리고 테두리만 그려집니다. 알아 두실 점 하나: 그 빈 곳의 클릭은 뒤에 있는 창에
...
1. **다운로드**: [Releases](https://github.com/rubidus-api/hgfloater/releases/tag/v0.12.0)
