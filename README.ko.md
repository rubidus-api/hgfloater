...
1. **다운로드**: [Releases](https://github.com/rubidus-api/hgfloater/releases/tag/v26.07.29c)
...
노트북 내장 화면은 DDC/CI 장치가 아니라서 지금은 감마 램프로 떨어집니다. 그 백라이트를
실제로 제어하려면 네 번째 경로가 필요하고, `docs/RFC-2026-07-brightness-control.md`에
정리해 두었습니다. 아직 구현되지 않았습니다.
