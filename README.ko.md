...
1. **다운로드**: [Releases](https://github.com/rubidus-api/hgfloater/releases/tag/v26.07.29f)
...
- **상태 막대**: CPU·온도·메모리·배터리의 가로 막대가 글자 뒤 전체 폭에 깔리고 왼쪽
  가장자리에 아주 작은 라벨이 붙습니다. 폭 전체가 100%입니다. 배터리가 없는 시스템에서는
