...
1. **다운로드**: [Releases](https://github.com/rubidus-api/hgfloater/releases/tag/v26.07.22)
...
- **_(현재 디스플레이 이름)_** — 태스크박스가 놓인 모니터의 이름을 단 하위 메뉴로, 윈도우
  디스플레이 배율(100, 125, 150, 175, 200, 225)이 들어 있습니다. 현재 배율에 체크 표시가
  붙고, 해당 모니터가 지원하지 않는 배율은 비활성화됩니다. 하나를 고르면 설정 앱과 똑같이 그
  모니터의 배율이 시스템 전체에 적용됩니다. 플로터와 태스크박스는 같은 모니터에 있으므로 둘
  다에 적용됩니다.
