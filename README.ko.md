...
**v0.15.3** — 빌드 2026-08-15 11:20 KST
...
1. **다운로드**: [Releases](https://github.com/rubidus-api/hgfloater/releases/tag/v0.15.3)
...
**윈도우 시작 시 실행**입니다. 두 항목은 `O` 메뉴에 회색으로 남아 `(off in this build)`
라고 안내합니다.
