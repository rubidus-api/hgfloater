...
**v0.7.0** — 빌드 2026-08-07 23:48 KST
...
1. **다운로드**: [Releases](https://github.com/rubidus-api/hgfloater/releases/tag/v0.7.0)
...
| 키 또는 클릭 | 하는 일 |
| :--- | :--- |
| `1`~`9`, 이어서 `a`~`z`, `A`~`Z` | 각 줄에 붙은 라벨. 누르면 그 탭으로 갑니다 |
| `0` | 마지막 줄 |
| `위`/`아래`, `Home`/`End` | 선택 이동 |
| `Enter`, 또는 클릭 | 선택한 탭으로 전환 |
| 오른쪽 클릭 | 그 탭을 닫습니다. 목록은 그대로 |
| `Esc` | 박스만 닫습니다. 키보드는 태스크박스에 그대로 |
