...
**v0.17.12** — built 2026-09-11

**[Download hgfloater.exe — v0.17.12, 650 KB](https://github.com/rubidus-api/hgfloater/releases/latest/download/hgfloater.exe)** · [All releases](https://github.com/rubidus-api/hgfloater/releases)
...
single **executable of about 650 KB** that needs no installer and no runtime, so
...
The arrows behave differently here than on the row of buttons, and that is the
point. Out there they are how you get from one button to the next, so a button
that took them would change how you leave it. In here the list is a column: Up
