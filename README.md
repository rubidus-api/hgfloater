...
**v0.17.10** — built 2026-09-03

**[Download hgfloater.exe — v0.17.10, 640 KB](https://github.com/rubidus-api/hgfloater/releases/latest/download/hgfloater.exe)** · [All releases](https://github.com/rubidus-api/hgfloater/releases)
...
single **executable of about 640 KB** that needs no installer and no runtime, so
