...
**v0.17.9** — built 2026-08-30

**[Download hgfloater.exe — v0.17.9, 630 KB](https://github.com/rubidus-api/hgfloater/releases/latest/download/hgfloater.exe)** · [All releases](https://github.com/rubidus-api/hgfloater/releases)
