...
#ifndef HG_VERSION_W
#define HG_VERSION_W L"v26.07.19e"
#endif
...
#define HG_STATUS_CLOCK_IDLE_MS 10000 /* status line falls back to the clock after this */

#define HG_TIMER_FLOATER_CLOCK 1
#define HG_TIMER_TASKBOX_REFRESH 1
