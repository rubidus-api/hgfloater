...
void hg_config_ensure_template(void)
{
    ...
    static const WCHAR block[] =
        ...
        L";\r\n"
        L";   [taskbox]    show_tabs     1 gives a tabbed application's tabs their own\r\n"
        L";                              task icons. Also in the O menu as\r\n"
        L";                              'Show Tabs as Task Icons'. Default 0: reading\r\n"
        L";                              tabs means asking the other application, which\r\n"
        L";                              is slow, so it is asked only every few seconds\r\n"
        L";                              and only of the classes listed below.\r\n"
        L";\r\n"
        L";   [taskbox]    tab_classes   extra window classes to look for tabs in,\r\n"
        L";                              separated by semicolons. Chromium browsers,\r\n"
        L";                              Explorer, Firefox, Windows Terminal and Notepad\r\n"
        L";                              are built in; this is for anything else.\r\n"
        L";                              'show windows class' in the command box prints\r\n"
        L";                              the class of every open window.\r\n"
        L";                              e.g. tab_classes=SomeApp_Frame;OtherApp\r\n"
        L";\r\n"
