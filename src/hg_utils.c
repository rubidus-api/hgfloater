...
static const HgToolbarBuiltinDescriptor hg_toolbar_builtin_descriptors[] = {
    {HG_TOOL_ICON_RESIZE, L"ReS", L"Drag to Resize Window", L"Drag to Resize Window", HG_TOOLBAR_VALUE_NONE,
    ...
    {HG_TOOL_ICON_COMMAND, L"Com", L"Command Box", L"Command Box", HG_TOOLBAR_VALUE_NONE,
     HG_TOOLBAR_CLICK_SHOW_COMMANDBOX, HG_TOOLBAR_DRAG_NONE},
    {HG_TOOL_ICON_NOTE, L"Nt", L"Notes", L"Notes", HG_TOOLBAR_VALUE_NONE, HG_TOOLBAR_CLICK_SHOW_NOTES,
