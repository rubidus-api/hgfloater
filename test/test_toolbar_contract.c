...
int main(void)
{
    ...
    failed |= expect_int("HG_TOOL_ICON_PIN", HG_TOOL_ICON_PIN, 9);
    failed |= expect_int("HG_TOOL_ICON_NOTE", HG_TOOL_ICON_NOTE, 10);
    failed |= expect_int("HG_TOOL_ICON_CLIP", HG_TOOL_ICON_CLIP, 11);
    ...
    const int icons[] = {HG_TOOL_ICON_RESIZE,  HG_TOOL_ICON_MOVE,       HG_TOOL_ICON_CLOSE,
                         ...
                         HG_TOOL_ICON_PIN,     HG_TOOL_ICON_NOTE,       HG_TOOL_ICON_CLIP};
